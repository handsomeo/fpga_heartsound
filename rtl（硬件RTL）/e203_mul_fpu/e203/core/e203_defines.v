...
//
  ...
  `endif
    ...
    `define E203_DECINFO_FPU_WIDTH     30
    `define E203_DECINFO_FPU_FADD      0
    `define E203_DECINFO_FPU_FSUB      1
    `define E203_DECINFO_FPU_FMUL      2
    `define E203_DECINFO_FPU_FMIN      3
    `define E203_DECINFO_FPU_FMAX      4
    `define E203_DECINFO_FPU_FMADD     5
    `define E203_DECINFO_FPU_FNMADD    6
    `define E203_DECINFO_FPU_FMSUB     7
    `define E203_DECINFO_FPU_FNMSUB    8
    `define E203_DECINFO_FPU_FCVT_W_S  9
    `define E203_DECINFO_FPU_FCVT_WU_S 10
    `define E203_DECINFO_FPU_FCVT_L_S  11
    `define E203_DECINFO_FPU_FCVT_LU_S 12
    `define E203_DECINFO_FPU_FCVT_S_W  13
    `define E203_DECINFO_FPU_FCVT_S_WU 14
    `define E203_DECINFO_FPU_FCVT_S_L  15
    `define E203_DECINFO_FPU_FCVT_S_LU 16
    `define E203_DECINFO_FPU_FSGNJ     17
    `define E203_DECINFO_FPU_FSGNJN    18
    `define E203_DECINFO_FPU_FSGNJX    19
    `define E203_DECINFO_FPU_FEQ       20
    `define E203_DECINFO_FPU_FLT       21
    `define E203_DECINFO_FPU_FLE       22
    `define E203_DECINFO_FPU_FCLASS    23
    `define E203_DECINFO_FPU_FMV_W_X   24
    `define E203_DECINFO_FPU_FMV_X_W   25
    `define E203_DECINFO_FPU_FDIV      26
    `define E203_DECINFO_FPU_FSQRT     27
    `define E203_DECINFO_FPU_FLW       28
    `define E203_DECINFO_FPU_FSW       29