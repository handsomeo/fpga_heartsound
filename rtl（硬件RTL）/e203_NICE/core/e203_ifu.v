...
module e203_ifu(
  ...
  input  [`E203_ITCM_DATA_WIDTH-1:0] ifu2itcm_icb_rsp_rdata,  //pc addr from itcm
  `endif//}
  ...
  input  ifu2biu_icb_cmd_ready, // Handshake ready,from biu_icb_arbt
            // Note: The data on rdata or wdata channel must be naturally
            //       aligned, this is in line with the AXI definition
  ...
  input  ifu2biu_icb_rsp_err,   // Response error,from biu_icb_arbt
            // Note: the RSP rdata is inline with AXI definition
  ...
  input  ifu_o_ready, //from exu_disp
  ...
  input  ifu_halt_req, //from exu_commit
  output ifu_halt_ack,
  ...
  input  dec2ifu_rden,
  input  dec2ifu_rs1en, //from exu
  input  [`E203_RFIDX_WIDTH-1:0] dec2ifu_rdidx,
  input  dec2ifu_mulhsu, //from exu_decode
  input  dec2ifu_div   , //from exu_decode
  input  dec2ifu_rem   , //from exu_decode
  input  dec2ifu_divu  , //from exu_decode
  input  dec2ifu_remu  , //from exu_decode
